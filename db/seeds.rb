...
file3 = URI.open('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9fckK4xM1XHLeEtA88hmlQx06tsFROeDEAw&usqp=CAU')
...
product1 = Product.create!(brand_id: brand1.id, name: "After-surf cactus", category: "Sneakers", description: "An ultra-comfortable trainer, made of recycled materials and handmade in Portugal",
...
product2 = Product.create!(brand_id: brand2.id, name: "Love T-Shirt", category: "T-shirt", description: "White printed T-shirt in organic cotton - love",
...
product3 = Product.create!(brand_id: brand2.id, name: "Turkana Top", category: "T-shirt", description: "White T-shirt in organic cotton",
                           environment: 80, labor: 0, animal: 100, composition: 10)
...
product4 = Product.create!(brand_id: brand3.id, name: "Flannel Shirt", category: "Shirt", description: "Blue grey organic cotton flannel shirt",
...
product5 = Product.create!(brand_id: brand3.id, name: "Willys Adventure", category: "Shirt", description: "Printed shirt regular fit hand-crafted.",
                           environment: 80, labor: 0, animal: 100, composition: 20)
...
puts "#{Feedback.count} feedbacks ont été créé(es)"
