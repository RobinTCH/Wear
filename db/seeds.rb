...
product2 = Product.create!(brand_id: brand2.id, name: "Air force one", description: "Small hands are suited for smaller details", picture: "https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/a42a5d53-2f99-4e78-a081-9d07a2d0774a/chaussure-air-force-1-07-pour-pXTXQ8.png",
                           environment: 20, labor: 0, animal: 100, composition: 10)
product3 = Product.create!(brand_id: brand2.id, name: "Air force two", description: "They've done it once, so they can do it twice", picture: "https://www.lesitedelasneaker.com/wp-content/images/2020/02/nike-air-force-1-low-sketch-white-black-cw7581-101-pic05.jpg",
